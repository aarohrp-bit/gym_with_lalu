...
const CACHE_NAME = "gym-with-lalu-v6";
...
const IMAGE_KEYS = [
  ...
  "4so763","8i68io","c38ld4","ooynug","r01yrl","f1oxlu","ar7ouu",
...
const IMAGE_URLS = IMAGE_KEYS.map((k) => `./exercises/${k}.webp`).concat([
  "./exercises/yzsm4o.jpg", // tricep card uses a JPEG
]);
