...
import { getProfile, verifyPin, setActive } from "@/lib/storage";
  ...
  return (
    <div className="w-full max-w-md mx-auto px-6 pt-8 pb-24 min-h-screen">
      ...
      <div className="mt-10 text-center">
        <div className="inline-flex w-14 h-14 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 items-center justify-center mb-5">
      ...
      {error && (
        <p className="text-center text-rose-400 text-sm font-body mb-6" data-testid="pin-error">Wrong PIN. Try again.</p>
      )}
